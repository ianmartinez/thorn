...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon37;
        icon37.addFile(QStringLiteral("../../icons/breeze-icons/icons/devices/16/input-keyboard.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon38;
        icon38.addFile(QStringLiteral("../../icons/breeze-icons/icons/actions/16/list-add.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon39;
        icon39.addFile(QStringLiteral("../../icons/breeze-icons/icons/actions/16/list-remove.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon40;
        icon40.addFile(QStringLiteral("../../icons/breeze-icons/icons/actions/16/run-build.svg"), QSize(), QIcon::Normal, QIcon::Off);
