...
ThornFrame::ThornFrame(wxWindow* parent,wxWindowID id)
{
    ...
    TreeCtrl1 = new wxTreeCtrl(SplitterWindow1, ID_TREECTRL1, wxPoint(264,281), wxDefaultSize, wxTR_DEFAULT_STYLE, wxDefaultValidator, _T("ID_TREECTRL1"));
    wxTreeItemId TreeCtrl1_Item1 = TreeCtrl1->AddRoot(_T("Project"));
    wxTreeItemId TreeCtrl1_Item2 = TreeCtrl1->AppendItem(TreeCtrl1_Item1, _T("Pages"));
    wxTreeItemId TreeCtrl1_Item3 = TreeCtrl1->AppendItem(TreeCtrl1_Item1, _T("Dictionary"));
    wxTreeItemId TreeCtrl1_Item4 = TreeCtrl1->AppendItem(TreeCtrl1_Item1, _T("Media"));
    TreeCtrl1->ScrollTo(TreeCtrl1_Item2);
    Panel1 = new wxPanel(SplitterWindow1, ID_PANEL1, wxPoint(434,321), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL1"));
    SplitterWindow1->SplitVertically(TreeCtrl1, Panel1);
    SplitterWindow1->SetSashPosition(350);
    ...
    TreeImages = new wxImageList(24, 24, 1);
